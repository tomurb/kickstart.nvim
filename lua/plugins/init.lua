...
return {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      { -- args like https://github.com/nvim-telescope/telescope-live-grep-args.nvim?tab=readme-ov-file#grep-argument-examples
  ...
  { -- adds new textobjects, like function, class etc.
    'nvim-treesitter/nvim-treesitter-textobjects',
  },

  { -- shows in which function you are
  ...
  { -- add ending to block (def, class etc.)}
